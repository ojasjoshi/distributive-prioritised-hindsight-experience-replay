...
import sys
sys.path.append('/Users/ojasjoshi/Desktop/distributive-prioritised-hindsight-experience-replay/core/vanilla/keras-rl/')
...
agent = DDPGAgent(nb_actions=nb_actions, actor=actor, critic=critic, critic_action_input=action_input,
                  memory=memory, nb_steps_warmup_critic=1000, nb_steps_warmup_actor=1000, batch_size=64,
                  random_process=random_process, gamma=.98, target_model_update=1e-3,
...
agent.fit(env, nb_steps=1000000, visualize=False, verbose=1, save_data_path=save_data_path_local, file_interval=10000)
