...
class DDPGAgent(Agent):
    ...
    def __init__(self, nb_actions, actor, critic, critic_action_input, memory,
        ...
        self.gamma = gamma
        self.target_model_update = target_model_update  # (TAU in case of soft targets)
        ...
        self.K = K  #(HER parameter)
        self.do_HER = do_HER
        self.do_PER = do_PER
        self.strategy = HER_strategy
        #weird PER parameter lingering in wrong function. (TODO: try to take it into memory.py)
