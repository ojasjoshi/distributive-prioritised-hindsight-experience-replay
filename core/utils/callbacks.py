...
class TrainEpisodeLogger(Callback):
    ...
    def on_episode_end(self, episode, logs):
        """ Compute and print training statistics of the episode when done """      # (add HER here)
...
## OJAS Implementation
""" saves success rate per episode with other metrics """
class OjasFileLogger(Callback):
