...
from rl.memory import NonSequentialMemory, SequentialMemory, PrioritisedNonSequentialMemory
...
memory = PrioritisedNonSequentialMemory(limit=50000, alpha=0.7, beta=0.5, window_length=1)
