...
def parse_arguments():
	...
	parser.add_argument('--gamma', dest='gamma',type=float, default=0.98,help="Value of gamma")
...
x1 = Dense(64)(flattened_observation1)
...
x2 = Dense(64)(flattened_observation2)
